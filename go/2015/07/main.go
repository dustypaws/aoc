/*
* This code is completely "stolen" from
* https://github.com/jwarwick/aoc_2015/blob/master/cmd/day07/day07.go
* since I've never done anything like that my own attempts failed every time.
* Maybe I'll manage Day 8 :)
 */
package main
